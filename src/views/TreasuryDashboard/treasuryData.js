...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all WATT staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing WATT.",
  ...
  holder: "Holders, represents the total number of WATTies (sWATT holders)",
  staked: "WATT Staked, is the ratio of sWATT to WATT (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sWATT emissions can be sustained at a given rate. Lower APY = longer runway",
};
